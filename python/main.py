...
parser = argparse.ArgumentParser(description = 'Web crawler to generate sitemap in xml')
...
group.add_argument('--domain', action="store", default="", help="Target domain (ex: http://manikandanselvaganesh.wordpress.com)")
